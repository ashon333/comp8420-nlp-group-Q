...
import { Home, Image as ImageIcon, ShoppingBag, Info, LogOut, ShoppingCart, Menu } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: 'Image Search', path: '/image-search', icon: ImageIcon },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-xl font-extrabold text-slate-800 tracking-tight">SoleStride</span>
          </div>
